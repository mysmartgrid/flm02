...
# svn co svn://localhost/openwrt/branches/backfire -r 27608 $BACKFIRE_PATH
# svn co svn://localhost/openwrt/tags/backfire_10.03 $BACKFIRE_PATH
#svn co svn://svn.openwrt.org/openwrt/branches/packages_10.03.1/net/ntpd $BACKFIRE_PATH/package/
...
##$BACKFIRE_PATH/scripts/feeds install -p packages ntp
...
patch -p0 < $REPO_PATH/patches/998-opkg-repo.patch
